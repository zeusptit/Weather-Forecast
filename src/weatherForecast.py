...
box_4 = RoundedButton(root, 240, 340, 20, 2, 'white', '#D8D6D6')
box_4.place(x = 540, y = 195)

box_5 = RoundedButton(root, 240, 60, 20, 2, '#77baf3', '#D8D6D6', command=anotherDayWeather)
box_5.place(x = 540, y = 550)
...
noti_Icon = Label(image=notiImage, bg="white")
...
thirdFrame_1 = Frame(root, width=80, height=160, bg="white")
thirdFrame_1.place(x = 60, y = 420)
...
canvas_1 = Canvas(root, width=20, height=150, bg="white")
canvas_1.config(highlightbackground="white")
canvas_1.place(x = 145, y = 420)


thirdFrame_2 = Frame(root, width=90, height=160, bg="white")
thirdFrame_2.place(x = 175, y = 420)
...
canvas_2 = Canvas(root, width=20, height=150, bg="white")
canvas_2.config(highlightbackground="white")
canvas_2.place(x = 263, y = 420)

thirdFrame_3 = Frame(root, width=80, height=160, bg="white")
thirdFrame_3.place(x = 293, y = 420)
...
canvas_3 = Canvas(root, width=20, height=150, bg="white")
canvas_3.config(highlightbackground="white")
canvas_3.place(x = 380, y = 420)

thirdFrame_4 = Frame(root, width=80, height=160, bg="white")
thirdFrame_4.place(x = 400, y = 420)
...
## Fourth Box
fourthFrame = Frame(root, width=220, height=30, bg="white")
fourthFrame.place(x = 550, y = 200)

fourthIntro = Label(fourthFrame, bg="white", fg="black", font="arial 12 bold")
fourthIntro.place(x = 10, y = 5)

fourthFrame_1 = Frame(root, width=220, height=40, bg="white")
...
canvas2_1 = Canvas(root, width=220, height=20, bg="white")
canvas2_1.config(highlightbackground="white")
canvas2_1.place(x = 550, y = 250)

canvas2_1.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_2 = Frame(root, width=220, height=40, bg="white")
fourthFrame_2.place(x = 550, y = 265)
...
canvas2_2 = Canvas(root, width=220, height=20, bg="white")
canvas2_2.config(highlightbackground="white")
canvas2_2.place(x = 550, y = 290)

canvas2_2.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_3 = Frame(root, width=220, height=40, bg="white")
fourthFrame_3.place(x = 550, y = 305)
...
canvas2_3 = Canvas(root, width=220, height=20, bg="white")
canvas2_3.config(highlightbackground="white")
canvas2_3.place(x = 550, y = 330)

canvas2_3.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_4 = Frame(root, width=220, height=40, bg="white")
fourthFrame_4.place(x = 550, y = 345)
...
canvas2_4 = Canvas(root, width=220, height=20, bg="white")
canvas2_4.config(highlightbackground="white")
canvas2_4.place(x = 550, y = 370)

canvas2_4.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_5 = Frame(root, width=220, height=40, bg="white")
fourthFrame_5.place(x = 550, y = 385)
...
canvas2_5 = Canvas(root, width=220, height=20, bg="white")
canvas2_5.config(highlightbackground="white")
canvas2_5.place(x = 550, y = 410)

canvas2_5.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_6 = Frame(root, width=220, height=40, bg="white")
fourthFrame_6.place(x = 550, y = 425)
...
canvas2_6 = Canvas(root, width=220, height=20, bg="white")
canvas2_6.config(highlightbackground="white")
canvas2_6.place(x = 550, y = 450)

canvas2_6.create_line(10, 10, 220, 10, width=2, fill="#D8D6D6")

fourthFrame_7 = Frame(root, width=220, height=40, bg="white")
fourthFrame_7.place(x = 550, y = 465)
...
canvas2_7 = Canvas(root, width=220, height=20, bg="white")
canvas2_7.config(highlightbackground="white")
canvas2_7.place(x = 550, y = 490)
